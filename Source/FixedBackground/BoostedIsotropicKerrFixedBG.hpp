...
#ifndef BOOSTEDISOTROPICKERRFIXEDBG_HPP_
#define BOOSTEDISOTROPICKERRFIXEDBG_HPP_
...
class BoostedIsotropicKerrFixedBG
{
  public:
    ...
    BoostedIsotropicKerrFixedBG(params_t a_params, double a_dx)
        : m_params(a_params), m_dx(a_dx)
    {
        ...
        if ((m_params.spin > m_params.mass) || (m_params.velocity < -m_params.mass))
        {
    ...
    data_t get_alpha(double M, double a, double V, data_t x, double y, double z) const {
        ...
        //DEBUG!!
        /*
        std::cout << "dxfunc0 : " << dx_func0 << std::endl;
        std::cout << "dyfunc0 : " << dy_func0 << std::endl;
        std::cout << "dzfunc0 : " << dz_func0 << std::endl;
        std::cout << "dxfunc1 : " << dx_func1 << std::endl;
        std::cout << "dyfunc1 : " << dy_func1 << std::endl;
                                   ...
                                   const Cell<data_t> &current_cell) const
    {
        ...
        std::cout << "K 12: " << vars.K_tensor[0][1] << std::endl;
        std::cout << "K 13: " << vars.K_tensor[0][2] << std::endl;
        std::cout << "K 22: " << vars.K_tensor[1][1] << std::endl;
        std::cout << "K 23: " << vars.K_tensor[1][2] << std::endl;
        std::cout << "K 33: " << vars.K_tensor[2][2] << std::endl;

        std::cout << "gamma 11: " << vars.gamma[0][0] << std::endl;
        std::cout << "gamma 12: " << vars.gamma[0][1] << std::endl;
        std::cout << "gamma 13: " << vars.gamma[0][2] << std::endl;
        std::cout << "gamma 22: " << vars.gamma[1][1] << std::endl;
        std::cout << "gamma 23: " << vars.gamma[1][2] << std::endl;
        std::cout << "gamma 33: " << vars.gamma[2][2] << std::endl;
        */
