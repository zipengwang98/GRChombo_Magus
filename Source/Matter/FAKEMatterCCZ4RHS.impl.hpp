...
#if !defined(FAKEMATTERCCZ4RHS_HPP_)
#error "This file should only be included through FAKEMatterCCZ4RHS.hpp"
#endif

#ifndef FAKEMATTERCCZ4RHS_IMPL_HPP_
#define FAKEMATTERCCZ4RHS_IMPL_HPP_
    ...
    Cell<data_t> current_cell) const
{
    ...
    VarsTools::assign(matter_rhs, 0.);
    //this->+(matter_rhs, matter_vars, d1, d2, advec);
...
#endif /* FAKEMATTERCCZ4RHS_IMPL_HPP_ */
