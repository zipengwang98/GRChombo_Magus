...
//!  The class allows extraction of the values of the Stress scalar components
//!  on spherical shells at specified radii, and integration over those shells
/*!
...
class StressExtraction
{
  ...
  public:
    //! The constructor
    StressExtraction(extraction_params_t a_params, double a_dx, double a_dt,
        ...
        : m_params(a_params), m_dt(a_dt), m_time(a_time),
          ...
          m_dtheta(M_PI / 2.0 / m_params.num_points_theta), m_dx(a_dx)
    {
    }
