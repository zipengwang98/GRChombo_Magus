...
#ifndef FIXEDBGCOMPLEXSCALARFIELD_HPP_
...
//   in the case of a fixed metric background
/*!
...
template <class potential_t = DefaultComplexPotential> class FixedBGComplexScalarField
{
  ...
  public:
    //!  Constructor of class FixedBGComplexScalarField
    FixedBGComplexScalarField(const potential_t a_potential)
...
#endif /* FIXEDBGCOMPLEXSCALARFIELD_HPP_ */
