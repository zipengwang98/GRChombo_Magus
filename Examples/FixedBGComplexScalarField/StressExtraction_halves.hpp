...
#ifndef STRESSEXTRACTION_HALVES_HPP_
#define STRESSEXTRACTION_HALVES_HPP_
...
#include "UserVariables.hpp" // Needs c_Stress and c_Momx
...
class StressExtraction_halves
{
  ...
  public:
    //! The constructor
  StressExtraction_halves(extraction_params_t a_params, double a_dt, double a_time,
  ...
  StressExtraction_halves(extraction_params_t a_params, double a_dt, double a_time,
      ...
      : StressExtraction_halves(a_params, a_dt, a_time, (a_dt == a_time),
                         a_restart_time)
    {
    }
  ...
  private:
    ...
    void write_integral(const std::vector<double> a_integral_Stress1,
...
#include "StressExtraction_halves.impl.hpp"

#endif /* STRESSEXTRACTION_HALVES_HPP_ */
